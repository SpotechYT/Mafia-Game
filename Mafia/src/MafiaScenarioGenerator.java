...
public class MafiaScenarioGenerator {
    ...
    private static final String EXAMPLES = """
            ...
            private static boolean sendExamples = true; // Set to false to disable examples
    ...
    public static StringBuilder getRAWScenario(String target, boolean saved) throws Exception {
        ...
        try {
            ...
            if(sendExamples) {
                prompt += "\n\n" + EXAMPLES;  // Append examples if enabled
                sendExamples = false;  // Disable examples after the first use
            }
